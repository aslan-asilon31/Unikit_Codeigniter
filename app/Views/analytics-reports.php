...
<body id="body" class="dark-sidebar">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <img src="/images/flags/us_flag.jpg" class="me-3 thumb-md align-self-center rounded" alt="...">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <img src="/images/flags/germany_flag.jpg" class="me-3 thumb-md align-self-center rounded" alt="...">
                                    <div class="media-body align-self-center">
                                        <div class="coin-bal">
                                            <h4 class="mt-0 mb-1 font-22 fw-bold">50,289</h4>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="media">
                                    <img src="/images/flags/spain_flag.jpg" class="me-3 thumb-md align-self-center rounded" alt="...">
                                    <div class="media-body align-self-center">
                                        <div class="coin-bal">
                                            <h4 class="mt-0 mb-1 font-22 fw-bold">50,289</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body position-reletive">
                                <img src="/images/small/svg-map.svg" alt="" class="img-fluid">
    ...
    <script src="/pages/analytics-report.init.js"></script>
    <!-- App js -->
