                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <form method="POST" class="my-4" action="<?= base_url('loginCheck') ?>">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="email" class="form-control" id="username" name="email" value="user@demo.com" placeholder="Enter username">
                                        </div><!--end form-group-->

                                        <div class="form-group">
                                            <label class="form-label" for="userpassword">Password</label>
                                            <input type="password" class="form-control" name="password" id="userpassword" value="password" placeholder="Enter password">
                                        </div><!--end form-group-->
