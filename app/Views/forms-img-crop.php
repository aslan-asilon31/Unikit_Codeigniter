...
<head>
    ...
    <link href="/libs/cropperjs/cropper.min.css" rel="stylesheet" type="text/css"/>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Image Cropper</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="img-container mb-0">
                                <img id="image" src="/images/small/img-1.jpg" alt="Picture">
                            </div>
                        </div><!--end card-body-->
                    </div><!--end card-->
                    <div id="actions">
                        <div class="card docs-buttons">
                            <div class="card-body">
                                ...
                                <div class="btn-group mb-2 mr-1">
                                    <button type="button" class="btn btn-light" data-method="setDragMode"
                                ...
                                <div class="btn-group mb-2 mr-1">
                                    <button type="button" class="btn btn-light" data-method="zoom" data-option="0.1"
                                            title="Zoom In">
                                            <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <div class="btn-group mb-2 mr-1">
                                    <button type="button" class="btn btn-light" data-method="move" data-option="-10"
                                    ...
                                    <button type="button" class="btn btn-light" data-method="move" data-option="0"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="getData"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="setData"
                                        data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="getContainerData"
                                        data-option data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="getImageData"
                                        data-option data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="getCanvasData"
                                        data-option data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="setCanvasData"
                                        data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="getCropBoxData"
                                        data-option data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="setCropBoxData"
                                        data-target="#putData">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="moveTo"
                                        data-option="0">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="zoomTo"
                                        data-option="1">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="rotateTo"
                                        data-option="180">
                                        <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                ...
                                <button type="button" class="btn btn-secondary mb-2 mr-1" data-method="scale"
                                ...
                                <textarea class="form-control" id="putData" rows="3"
                    ...
                    <div class="card docs-toggles">
                        <div class="card-body">
                            ...
                            <div class="dropdown dropup docs-options mt-3">
                                <button type="button" class="btn btn-secondary dropdown-toggle w-100" id="toggleOptions"
...
<script src="/pages/img-crop.js"></script>
<!-- App js -->
