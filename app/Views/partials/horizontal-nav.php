            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="/images/users/user-4.jpg" alt="profile-user" class="rounded-circle me-0 me-md-2 thumb-sm" />
                        <div class="user-name">
                ...
                <ul class="navigation-menu">
                        ...
                        <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDashboards">
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu animate slideIn">
                                    <li>
                                        <a href="index.html" class="dropdown-item " aria-labelledby="analyticsDashboards">Dashboard</a>
                                    </li>
                                    <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu  animate slideIn" aria-labelledby="navbarPages">
                            ...
                            <li>
                                <a class="dropdown-item" href="pages-treeview.html" aria-labelledby="navbarPages">Treeview</a>
                            </li><!--end /li-->
                            <li>
